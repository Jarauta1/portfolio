...
const english = {
    ...
    data: [
      {
        ...
        fileName: "FullStackImg",
        skills: [
          "⚡ Front-end development for web and smartphone applications",
          "⚡ Responsive design using ReactJS",
          "⚡ Back-end development with NodeJS, Express and MongoDB database",
        ],
        softwareSkills: [
          {
            skillName: "HTML5",
    ...
    degrees: [
      {
        ...
        descriptions: [
          ...
          "⚡ Server-side web programming: Node.js and Express",
          "⚡ Client-side web programming: HTML5, CSS3, JavaScript",
          "⚡ Use of SPA framework (React)",
      ...
      },
      {
        ...
        subtitle: "San Valero (Higher training center), Zaragoza",
        logo_path: "sanvalero.png",
        alt_name: "San Valero",
        duration: "2012 - 2014",
        descriptions: [
          "⚡ Analogue electronics",
          "⚡ Wired digital systems",
          "⚡ Microprogrammable systems",
          "⚡ Development and construction of electronic prototypes",
          "⚡ Electronic equipment maintenance",
          "⚡ Small business administration, management and marketing",
          "⚡ Programming techniques",
          "⚡ Systems electronics",
          "⚡ Development of electronic product projects",
          "⚡ Quality",
          "⚡ Relationships in the working team",
  ...
  certifications : {
    certifications: [
      ...
      {
        title: "Leadership skills and team management",
        subtitle: "EuroFor",
        logo_path: "eurofor.png",
        certificate_link:
          "https://drive.google.com/file/d/16EDFaIKHmrvZXWy7NWv3x-M2eekS_Zqn/view",
  ...
  experience : {
    ...
    description:
      "Throughout my career I have been collaborating with organisations or carried out projects on my own. I love organizing workshops to share my knowledge, train and motivate people to enter the technological world.",
    header_image_path: "experience.svg",
    sections: [
      {
        ...
        experiences: [
          {
            ...
            description:
              ...
              ➢ Javascript programming
              ➢ MongoDB database programming
              ➢ Server-side web programming (Nodejs and Express)
              ➢ Client-side web programming: HTML5, CSS3, JavaScript and Bootstrap 4
              ➢ Use of SPA framework (React)
              ➢ Scrum (agile methodologies)
              ➢ Final project based on MERN
              ➢ GIT / Version Control`,
            color: "#0071C5",
          },
          {
            ...
            description:
              ...
              ➢ Redesign of power electronic equipment for lighting (LED)
              ➢ Carrying out homologation tests in accordance with the regulations
              ➢ Management, coordination and supervision of technical tests
              ➢ Design of power electronic equipment for lighting (LED)
              ➢ SMD welding`,
            color: "#ee3c26",
          },
          {
            title: "Etopia Kids Cologne Technical Monitor",
            company: "Ayuntamiento de Zaragoza",
            company_url: "https://www.etopiakids.es/",
            logo_path: "etopia.png",
            duration: "06/2014 - 07/2014",
          ...
          },
          {
            ...
            description:
              ...
              ➢ R + D + i
              ➢ Train workers and customers in robotics and 3D technology
              ➢ Projects with Arduino
              ➢ Creation of applications for Smartphone with App Inventor`,
            color: "#ee3c26",
          },
        ],
      },
      {
        ...
        experiences: [
          {
            title: "Arduino Day technical monitor",
            company: "Gobierno de Aragón",
            company_url: "https://arduinodayzgz.es/",
            logo_path: "arduinoday_2016.png",
            duration: "03/2016",
            location: "Zaragoza",
            description:
              "Arduino day is an event that was born to commemorate the anniversary of Arduino in which I give technical talks on C ++ code and I teach introductory course on programming.",
            color: "#4285F4",
          },
          {
            title: "Arduino Day technical monitor",
          ...
          },
          {
            ...
            location: "Spain",
            description:
              "Initiative of the Sicnova 3D company to teach courses where I teach the assembly of 3D printers and initiation to programming at all its headquarters in Spain.",
            color: "#C681C3",
          },
          {
            title: "Arduino Day technical monitor",
    ...
    data: [
      {
        ...
        url: "https://github.com/Jarauta1/DJ-cliente",
        description:
          "Full Stack project for an e-commerce web page based on MERN Stack (MongoDB, Express.js, React.js, Node.js) with different sections and a data analysis accessible only to users with administrator rank.",
        languages: [
          {
            name: "HTML5",
            logo_path: "html5.png",
